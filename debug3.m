...
H = zeros(K, N);
H(:, N-K+1:end) = eye(K);
H(:, 1:N-K) = dirichlet_rnd(ones(K, 1), N-K);
...
xlabel('SNR')
legend
saveas(gcf, 'results/2_success_rate.eps', 'epsc')
...
xlabel('SNR')
legend
saveas(gcf, './results/2_success_rate2.eps', 'epsc')
...
xlabel('SNR')
legend
saveas(gcf, './results/2_mse_l2.eps', 'epsc')
...
xlabel('SNR')
legend
saveas(gcf, './results/2_Wmse_l2.eps', 'epsc')
