...
plot(list_SNR, mean(Tracking.fw(1, :, :), 3), '-s', 'DisplayName',  '\texttt{MERIT}', 'Color', fw_color)
hold on
plot(list_SNR, mean(Tracking.fg(1, :, :), 3), '-o', 'DisplayName',  '\texttt{FastGradient}', 'Color', fg_color)
plot(list_SNR, mean(Tracking.spa(1, :, :), 3), '-^', 'DisplayName',  '\texttt{SPA}', 'Color', spa_color)
legend('Location',  'SouthEast')
xlabel('SNR')
ylabel('success rate')
saveas(gcf, './results/R1_table/succ_K_10.eps', 'epsc')

figure('DefaultAxesFontSize', 18);
plot(list_SNR, mean(Tracking.fw(2, :, :), 3), '-s', 'DisplayName',  '\texttt{MERIT}', 'Color', fw_color)
hold on
plot(list_SNR, mean(Tracking.fg(2, :, :), 3), '-o', 'DisplayName',  '\texttt{FastGradient}', 'Color', fg_color)
plot(list_SNR, mean(Tracking.spa(2, :, :), 3), '-^', 'DisplayName',  '\texttt{SPA}', 'Color', spa_color)
legend('Location',  'SouthEast')
xlabel('SNR')
ylabel('success rate')
saveas(gcf, './results/R1_table/succ_K_20.eps', 'epsc')

figure('DefaultAxesFontSize', 18);
plot(list_SNR, mean(Tracking.fw(3, :, :), 3), '-s', 'DisplayName',  '\texttt{MERIT}', 'Color', fw_color)
hold on
plot(list_SNR, mean(Tracking.fg(3, :, :), 3), '-o', 'DisplayName',  '\texttt{FastGradient}', 'Color', fg_color)
plot(list_SNR, mean(Tracking.spa(3, :, :), 3), '-^', 'DisplayName',  '\texttt{SPA}', 'Color', spa_color)
legend('Location',  'SouthEast')
xlabel('SNR')
ylabel('success rate')
saveas(gcf, './results/R1_table/succ_K_30.eps', 'epsc')
