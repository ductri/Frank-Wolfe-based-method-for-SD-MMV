...
tmp = max([max(Tracking.spa_MRSA(:)) max(Tracking.fw_MRSA(:)) max(Tracking.fg_MRSA(:))]);
mean(Tracking.fw_MRSA(:, 6, :), 3)/tmp*100
mean(Tracking.fw0_MRSA(:, 6, :), 3)/tmp*100
mean(Tracking.fg_MRSA(:, 6, :), 3)/tmp*100
mean(Tracking.spa_MRSA(:, 6, :), 3)/tmp*100
